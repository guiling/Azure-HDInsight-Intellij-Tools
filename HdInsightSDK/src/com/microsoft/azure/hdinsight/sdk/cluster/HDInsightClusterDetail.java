 ...
 */
public class HDInsightClusterDetail implements IClusterDetail {
    ...
    public HDInsightClusterDetail(String clusterName, String userName, String passWord, List<StorageAccount> storageAccounts)
    {
